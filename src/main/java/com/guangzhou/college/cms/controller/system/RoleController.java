...
import com.guangzhou.college.cms.service.system.SysRoleService;
import com.guangzhou.college.cms.service.system.SysUserService;
import com.guangzhou.college.common.ResultInfo;
import com.guangzhou.college.common.ReturnCodeEnum;
import com.guangzhou.college.common.utils.PageUtil;
import com.guangzhou.college.entity.system.SysRole;
import com.guangzhou.college.entity.system.SysRoleRequest;
import com.guangzhou.college.entity.system.SysUser;
...
public class RoleController {
    ...
    public Object getSysRoleById(String roleId) {
        try {
            log.info("getSysRoleById roleId : {}",roleId);
            ResultInfo resultInfo = new ResultInfo();
            ...
            log.error("getSysRoleById roleId : {}",roleId,e);
            return ResultInfo.newExceptionResultInfo();
        }
    ...
    public Object getAllRoleList() {
        try {
            log.info("getAllRoleList ....");
            ResultInfo resultInfo = new ResultInfo();
            resultInfo.setData(sysRoleService.getAllRoleList());
            return resultInfo;
        }catch (Exception e){
            log.error("getAllRoleList ....",e);
            return ResultInfo.newExceptionResultInfo();
        }
    ...
    public Object deleteSysRole(String roleId) {
        try {
            log.info("deleteSysRole roleId : {}",roleId);
            ResultInfo resultInfo = new ResultInfo();
            if (StringUtils.isBlank(roleId)) {
                return  ResultInfo.newEmptyParamsResultInfo();
            }
            ...
            log.error("deleteSysRole roleId : {}",roleId,e);
            return  ResultInfo.newExceptionResultInfo();
        }
