package com.guangzhou.college.local;
...
public class Api_java_demo {
	...
	public static final String USER = "eecup2019@outlook.com";//*必填*：账号名
	public static final String UKEY = "kx3B8LCMtFNN5KsL";//*必填*: 注册账号后生成的UKEY
	public static final String SN = "xxxxxxxxx";//*必填*：打印机编号，必须要在管理后台里添加打印机或调用API接口添加之后，才能调用API
...
//			System.out.println(method4);
	...
	private static String execute(CloseableHttpClient httpClient, HttpPost post, List<NameValuePair> nvps, CloseableHttpResponse response, String result) {
		try
		{
